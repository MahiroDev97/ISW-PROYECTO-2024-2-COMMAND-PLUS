...
export default function Popup({ show, setShow, categories, action, producto }) {
  ...
  useEffect(() => {
    if (show && producto) {
      const productData = Array.isArray(producto) ? producto[0] : producto;
      setFormData({
        id: productData.id,
        ...
        disponibilidad: productData?.disponibilidad ?? true,
